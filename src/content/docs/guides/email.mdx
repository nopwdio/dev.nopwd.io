...
From your login page, add the `<np-email-login>` component and set the `email` property with your user's email address.
...
<LinkCard
  title="np-email-login reference"
  description="Learn how to customize it."
  href="/reference/components/np-email-login"
/>
