...
<script type="module">
  ...
  button.email = "ada@lovelace.uk"; // from an input field somewhere
</script>
```
...
Once the user authenticated, consider offering him an even smoother and secure experience by letting them use Passkeys.
