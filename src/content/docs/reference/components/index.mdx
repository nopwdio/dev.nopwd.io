...
Nopwd provides one components to handle **magic link** authentication:

| name                                                     | Type     | Description                           |
| -------------------------------------------------------- | -------- | ------------------------------------- |
| [`np-email-login`](/reference/components/np-email-login) | `button` | Authenticate a user with a magic-link |

and two other to provide **passkey** authentication:

| name                                                               | Type     | Description                      |
| ------------------------------------------------------------------ | -------- | -------------------------------- |
| [`np-passkey-register`](/reference/components/np-passkey-register) | `button` | Register a passkey               |
| [`np-passkey-login`](/reference/components/np-passkey-login)       | `input`  | Authenticate a user with passkey |
